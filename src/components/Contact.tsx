...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        "Thank you! We'll call you back within 2 hours during business hours."
      );
      setFormData({
        firstName: "",
        lastName: "",
          ...
          <Card className="border-2 border-border">
            <CardHeader>
              ...
              <CardDescription className="text-base">
                Fill out the form below and a specialist will call you back
                ...
                <div className="space-y-2 mb-6">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="multi-drop">
                        Multi-Drop Courier
                      </SelectItem>
                      <SelectItem value="van-day-rate">
              ...
              <Card className="p-6 border-2 hover:border-logistics-orange/20 transition-colors duration-300">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@fleetory.co.uk" className="text-muted-foreground">
                      info@fleetory.co.uk
                    </a>
                  </p>
            ...
            <Card className="p-6 border-2">
              ...
              <div className="space-y-3 text-muted-foreground">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-logistics-orange">
                    24/7, 365 Days
                  </span>
                </div>
                <div className="flex justify-between">
