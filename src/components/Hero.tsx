...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center mt-4 md:mt-18 justify-center bg-gradient-to-br from-logistics-blue to-logistics-blue-light overflow-hidden">
