import { Phone, Mail, MapPin, MessageCircle, Clock, Truck, Building, FileText, Users } from "lucide-react";
    ...
    <footer className="bg-logistics-dark text-white">
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-4 lg:col-span-1">
            ...
            <p className="text-white/80 leading-relaxed text-sm">
              ...
              From urgent documents to pallet deliveries, we've got you covered 24/7.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              >
                ...
                <span>Fleetory@outlook.com</span>
              </a>
        ...
        <div className="bg-white/10 rounded-xl p-8 mt-12 text-center">
          <h3 className="text-2xl font-bold mb-4">Ready to Book Your Delivery?</h3>
