        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl leading-relaxed opacity-90 mb-8">
              Guaranteed same-day courier delivery across the UK with rapid
              60-minute collection
            </p>
            <p className="text-lg leading-relaxed opacity-80 max-w-3xl mx-auto mb-8">
              When time is critical, Fleetory's same-day delivery service
              ensures your packages arrive exactly when needed. Our extensive
              network of professional drivers guarantees collection within 60
              minutes and delivery the same day.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Fast, reliable, and secure same-day courier services across the
              entire UK
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Rapid collection within 60 minutes of booking confirmation
                  across the UK
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Track your driver from collection to delivery with live GPS
                  updates
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Comprehensive goods in transit insurance for complete peace of
                  mind
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Instant POD with signature and photo confirmation upon
                  delivery
                </CardDescription>
              </CardHeader>
            </Card>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Simple, fast, and reliable - get your same day delivery booked in
              minutes
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Get an instant quote online or call our team. Provide pickup and
                delivery addresses with any special requirements.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-logistics-blue rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-6">
              ...
              <p className="text-gray-600">
                Our driver arrives within 60 minutes for collection. Track them
                in real-time via our app or website.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-logistics-blue rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-6">
              ...
              <p className="text-gray-600">
                Direct delivery to your recipient with instant proof of delivery
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From legal documents to medical supplies, we handle urgent
              deliveries across all sectors
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Court filings, contracts, and confidential papers with secure handling",
              },
              {
                title: "Medical Supplies",
                description:
                  "Urgent pharmaceutical deliveries and medical equipment transport",
              },
              {
                title: "Business Parcels",
                description:
                  "Critical business documents and packages between offices",
              },
              {
                title: "Spare Parts",
                description:
                  "Manufacturing components and equipment parts for minimal downtime",
              },
              {
                title: "Retail Stock",
                description:
                  "Emergency inventory and customer order fulfillment",
              },
              {
                title: "Personal Items",
                description: "Important personal documents and valuable items",
              },
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-3xl mx-auto text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Join thousands of businesses who trust Fleetory for their urgent
              delivery needs. Available 24/7, 365 days a year across the entire
              UK.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
