        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-lg leading-relaxed opacity-80 max-w-3xl mx-auto mb-8">
              From small vans to large Luton vehicles, Fleetory's light haulage
              service handles oversized, palletised, and specialist deliveries
              across the UK. Our professional drivers and wide range of vehicles
              ensure your valuable goods arrive safely.
            </p>
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-3xl mx-auto text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              ...
              light haulage service handles it all with professional care and
              the right equipment.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
