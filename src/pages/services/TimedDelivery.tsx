        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl leading-relaxed opacity-90 mb-8">
              Guaranteed time-slot delivery when your package must arrive at a
              specific time
            </p>
            <p className="text-lg leading-relaxed opacity-80 max-w-3xl mx-auto mb-8">
              When timing is everything, Fleetory's timed delivery service
              provides scheduled pickup and delivery within specific time
              windows. Perfect for coordinated logistics, installations, and
              deadline-critical deliveries.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Choose the perfect delivery window to match your schedule and
              requirements
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow border-2 hover:border-logistics-orange/20">
              <CardHeader>
                ...
                <CardDescription className="text-lg font-semibold text-logistics-blue mb-2">
                  8:00 AM - 12:00 PM
                </CardDescription>
                <CardDescription>
                  Perfect for business deliveries that need to arrive before
                  lunch
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow border-2 hover:border-logistics-orange/20">
              <CardHeader>
                ...
                <CardDescription>
                  Ideal for coordinating with installations or afternoon
                  meetings
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow border-2 hover:border-logistics-orange/20">
              <CardHeader>
                ...
                <CardDescription>
                  Great for residential deliveries when recipients are home from
                  work
                </CardDescription>
              </CardHeader>
            </Card>
          ...
          <div className="text-center mt-12">
            <Card className="max-w-md mx-auto border-logistics-blue border-2">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-logistics-blue">
                  Custom Time Slots
                </CardTitle>
                <CardDescription>
                  Need a specific 1-2 hour window? We can arrange custom
                  delivery slots to match your exact requirements.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              When your delivery timing needs to coordinate with other
              activities
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Coordinate material delivery with installation teams to minimize waiting time and maximize efficiency.",
                features: [
                  "Equipment arrival before technicians",
                  "Building materials for contractors",
                  "Furniture for office setups",
                ],
              },
              {
                title: "Event Logistics",
                description:
                  "Ensure critical items arrive exactly when needed for events, conferences, and presentations.",
                features: [
              ...
              },
              {
                ...
                description:
                  "Time-sensitive medical supplies and equipment delivery for scheduled procedures.",
                features: [
                  "Surgical equipment",
                  "Patient records",
                  "Medical supplies",
              ...
              },
              {
                ...
                description:
                  "Important documents and materials delivered precisely when your meeting starts.",
                features: [
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Select your preferred delivery window during the booking
                process.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Provide pickup and delivery addresses with any special
                instructions.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Monitor your delivery with real-time updates and ETA
                notifications.
              </p>
            </div>
            <div className="text-center">
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-3xl mx-auto text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Don't leave critical deliveries to chance. Schedule your timed
              delivery with guaranteed time slots and professional handling
              across the UK.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
